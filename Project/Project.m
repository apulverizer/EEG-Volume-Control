...
% model = svmtrain(BreastCancerData.Learning.Labels,BreastCancerData.Learning.Features,'-t 0 -c 9.7038 -g .0000233 -q');
...
% model = svmtrain(LiverData.Learning.Labels,LiverData.Learning.Features,'-t 0 -c 73.446 -g 0.0000121 -q');
...
% Collected Data
fprintf('CollectedData\n');
params = sprintf('-t 0 -c %f -g %f -q', 129.74, 1.0212);
...
modelRBFN = rbfnTrain(CollectedData.Learning.Labels,CollectedData.Learning.Features,98,0.714870,1,2);
...
[predictions, accuracy] = rbfnPredict(CollectedData.Learning.Labels,CollectedData.Learning.Features,modelRBFN,1,2);
