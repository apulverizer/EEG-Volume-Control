function [fitness] = FitnessFunctionRBFN(C,G, Data, Class1Label,Class2Label)
    ...
    modelRBFNValidation = rbfnTrain(Data.Learning.Labels,Data.Learning.Features,C,G,Class1Label,Class2Label);
    ...
    fitness = abs(accuracy1-accuracy2)/(accuracy1(1)+accuracy2(1));
